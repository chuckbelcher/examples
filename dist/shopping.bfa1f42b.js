...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/shopping.js":[function(require,module,exports) {
...
list = document.querySelector('.list'); //Array to hold state

var items = [];

var handleItemSubmit = function handleItemSubmit(e) {
  e.preventDefault();
  ...
  e.currentTarget.item.value = ''; //fire off event that broadcasts item has been updated
...
list.addEventListener('itemsUpdated', sendToLocalStorage); //Event deligation listen on list and delegate to button
...
},{}]},{},["../../../../usr/local/Cellar/node/14.5.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/shopping.js"], null)
//# sourceMappingURL=/shopping.bfa1f42b.js.map