...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/gallery-prototype.js":[function(require,module,exports) {
function Gallery(gallery) {
  ...
  this.gallery = gallery; //select elements

  this.images = Array.from(gallery.querySelectorAll('img'));
  this.modal = document.querySelector('.modal');
  this.prevButton = this.modal.querySelector('.prev');
  this.nextButton = this.modal.querySelector('.next'); //bind methods to instance

  this.showNextImage = this.showNextImage.bind(this);
  this.showPrevImage = this.showPrevImage.bind(this);
  this.handleKeyUp = this.handleKeyUp.bind(this);
  this.closeModal = this.closeModal.bind(this);
  this.handleOutsideClick = this.handleOutsideClick.bind(this); //Event Listeners
  ...
  this.images.forEach(function (image) {
    image.addEventListener('keyup', function (e) {
      if (e.key === 'Enter') return _this.showImage(e.currentTarget);
    });
  });
...
Gallery.prototype.closeModal = function () {
  this.modal.classList.remove('open'); //TODO: Add event listener for clicks adn keyboard
...
},{}]},{},["../../../../usr/local/Cellar/node/14.5.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/gallery-prototype.js"], null)
//# sourceMappingURL=/gallery-prototype.f1b6beb2.js.map